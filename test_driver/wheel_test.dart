...
Future<void> main(List<String> args) async {
  var out = File('test_driver/wheel_test.log');
  ...
  var r = await Process.run('powershell', <String>[
    '-NoProfile',
    '-ExecutionPolicy',
    'Bypass',
    '-File',
  ...
  var r2 = await Process.run('powershell', <String>[
    '-NoProfile',
    '-ExecutionPolicy',
    'Bypass',
    '-File',
  ...
  say(
    'WHEEL DOWN rc=${r2.exitCode} '
    'out=${(r2.stdout as String).trim()} '
    'err=${(r2.stderr as String).trim()}',
  );
